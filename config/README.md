...
```bash
python3 scripts/indexing/project_config.py --format json --backend sparse [--project aosp_project] [--config /path/projects.yaml]
python3 scripts/indexing/project_config.py --format json --backend dense [--project aosp_project] [--config /path/projects.yaml]
python3 scripts/indexing/project_config.py --format json --backend structural [--project aosp_project] [--config /path/projects.yaml]
```
...
python3 scripts/indexing/project_config.py --format json --backend structural --project aosp_project
...
python scripts/indexing/structural/build_structural_index.py --source-root /opt/aosp/aosp_project --project-name aosp_project --reset
```
