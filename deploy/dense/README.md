...
#    (requires AOSP_SOURCE_ROOT in the project root .env — default /opt/aosp/aosp_project)
...
5. Run the indexer: `docker compose --profile indexer run --rm dense-indexer --project-name <proj> --source-dir /src/<...>` (entrypoint already targets `deploy/dense/scripts/build_dense_index.py`).
