...
OMP_NUM_THREADS = int(os.environ.get("OMP_NUM_THREADS", "4"))
INTER_OP_NUM_THREADS = int(os.environ.get("ORT_INTER_OP_NUM_THREADS", "1"))
MAX_BATCH_SIZE = int(os.environ.get("EMBEDDING_MAX_BATCH_SIZE", "256"))
