...
class Ingester:
    ...
    def __init__(
        ...
        self.log_path = Path(log_path) if log_path else config.SP_COCKPIT_AUDIT_LOG_PATH
        self.db_path = Path(db_path) if db_path else config.SP_COCKPIT_AUDIT_DB_PATH
