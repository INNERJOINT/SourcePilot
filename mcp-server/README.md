...
2. Pick the project the user is working on (e.g. `aosp_project`, `t2`).
...
```
list_projects()
search_code(query="binder_open", project="aosp_project")
get_file_content(repo="frameworks/base", filepath="core/java/android/os/Binder.java", project="aosp_project")
```
