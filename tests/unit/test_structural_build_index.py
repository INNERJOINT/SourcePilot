...
def test_derive_repo_and_path_with_explicit_repo_name():
    repo, rel_path, mode = bgi._derive_repo_and_path(
        file_path="/opt/aosp/aosp_project/frameworks/base/core/java/Foo.java",
...
def test_derive_repo_and_path_packages_default():
    repo, rel_path, mode = bgi._derive_repo_and_path(
        file_path="/opt/aosp/aosp_project/packages/modules/StatsD/src/Main.java",
        source_root="/opt/aosp/aosp_project",
        project="aosp_project",
    )
...
def test_derive_repo_and_path_from_repo_root_source_root():
    repo, rel_path, mode = bgi._derive_repo_and_path(
        file_path="/opt/aosp/aosp_project/frameworks/base/services/Service.java",
        source_root="/opt/aosp/aosp_project/frameworks/base",
        project="aosp_project",
    )
...
def test_derive_repo_and_path_project_root_fallback():
    repo, rel_path, mode = bgi._derive_repo_and_path(
        file_path="/opt/aosp/aosp_project/system/core/init/main.cpp",
        source_root="/opt/aosp/aosp_project",
        project="aosp_project",
    )

    assert repo == "aosp_project"
